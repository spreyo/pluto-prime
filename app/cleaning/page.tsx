...
const heroImage =
  "https://images.unsplash.com/photo-1581578731548-c64695cc6952?auto=format&fit=crop&w=1300&q=85";
          ...
          <div className="relative mx-auto max-w-3xl">
            ...
            >
              ...
              <p>
                ...
                domov, kancelárií, hotelov a spoločných priestorov. Každý
        ...
        <MotionSection className="px-6 pb-12 pt-8 sm:px-10 lg:pb-20">
          <div className="mx-auto grid max-w-5xl gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:items-start lg:gap-16">
            <MotionBlock className="mx-auto max-w-xl text-left lg:pt-8">
              <BrushCleaning className="mx-auto h-16 w-16 stroke-[1.8] text-[#c98b13] lg:mx-0" />
